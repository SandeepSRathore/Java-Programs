...
class Editer extends WindowAdapter implements ActionListener,KeyListener
{			/////////////////////////INSTANCE VARIABLES//////////////////////////
	...
	int flag;
	boolean typed=false,pressed=false;	
	TextField t1,t2,t3;
	...
	{		//////////////// MAIN FRAME CREATION////////////////////////////////////////
		...
		b2.addActionListener(new ActionListener()
		{
			...
			{
				public void actionPerformed(ActionEvent e)
				{	if(f.getTitle().equals(Title)&typed==false)
					{
					f.setVisible(false);
					f.dispose();
					System.exit(1);
	...
	public void keyPressed(KeyEvent k){pressed=true;System.out.print("pressed");}
